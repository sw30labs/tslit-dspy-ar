...
vals = {
    'compile_model': c.get('compile_model', 'ollama/nemotron-3-super:120b-a12b-bf16'),
    'inference_model': c.get('inference_model', 'ollama/llama3.1:8b'),
    'auto_setting': c.get('auto_setting', 'light'),
    'num_threads': c.get('mipro', {}).get('num_threads', 4),
    'max_boot': c.get('mipro', {}).get('max_bootstrapped_demos', 4),
    'max_labeled': c.get('mipro', {}).get('max_labeled_demos', 8),
